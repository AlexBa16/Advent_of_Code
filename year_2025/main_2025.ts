...
import {day12_part1, day12_part2} from "./days/day12.ts";
...
//
console.log("===== Day12 =====");
console.log('Part1:', day12_part1(readFileAsArray(2025, 12)));
console.log('Part2:', day12_part2(readFileAsArray(2025, 12)));
